  ...
  return (
    <div className="min-h-screen w-full bg-[#ECE3DA]">
      ...
      <div className="max-w-6xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <h2 className="text-center font-urbanist font-semibold text-black mb-6 text-[28px] sm:text-[36px] md:text-[40px] lg:text-[45px] leading-[36px] sm:leading-[44px] md:leading-[48px] lg:leading-[53.18px] tracking-[0.2px]">
          Book Your Seats Now
        </h2>

        <Tracking />

        <div className="flex  lg:flex-row  gap-4 sm:gap-6 md:gap-8 sm:mt-5 md:mt-7 lg:mt-9">
          {/* Left Section */}
