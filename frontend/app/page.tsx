...
import { urbanist, plusJakarta } from '../app/fonts';
    ...
    <div className="w-full min-h-screen bg-[#ECE3DA]">
      ...
      <div className="w-full min-h-screen px-4 sm:px-8 md:px-12 lg:px-20 xl:px-40 py-6 md:py-14 lg:py-20">
        ...
        <div className="flex items-center justify-center">
          <div className="relative w-full bg-[#EFEAE5] rounded-2xl shadow-lg p-3 md:p-8 lg:p-12 flex flex-col md:flex-row items-center justify-between gap-4 md:gap-8 lg:gap-16 mt-8 md:mt-16 lg:mt-20">
            ...
            <div className="left_intro_part max-w-full md:max-w-lg p-3 text-center md:text-left flex flex-col items-center md:items-start z-10">
              <h1 className={`${urbanist.className} font-light text-4xl sm:text-5xl leading-tight tracking-[0.38px] text-black mb-4`}>
              ...
              <p className={`${plusJakarta.className} font-light text-sm sm:text-base md:text-lg leading-[22.73px] tracking-[0.13px] text-black mb-6 mt-3 md:mt-5 text-center md:text-left md:ml-4 align-middle`}>
                Manage books, seat bookings,
                <br />
                members, and digital libraries.
              </p>

              <button className="bg-black text-white px-8 py-3 rounded-full text-sm md:text-base font-light leading-tight flex items-center gap-2 hover:bg-gray-900 transition">
                Get Started
        ...
        <div className="py-4 sm:py-6 md:py-8 lg:py-12 mt-4 sm:mt-6 md:mt-8 mb-4 sm:mb-6 md:mb-8">
          <h1 className={`${plusJakarta.className} font-medium text-2xl sm:text-3xl md:text-4xl lg:text-5xl leading-[1.2] tracking-[0.29px] text-black text-center mx-auto px-4`}>
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col md:flex-row items-start">
        ...
        <div className="py-5 px-2 w-full md:flex-grow">
          ...
          <div className="mt-1 text-center text-black">
            <h1 className={`${plusJakarta.className} font-bold text-3xl sm:text-4xl leading-tight tracking-normal text-gray-900 mb-4`}>
              Smart Libraries. Smarter Learning
            </h1>
            {/* line */}
            <div className="w-28 h-1.5 bg-[#796146] mx-auto mb-6 rounded-xl"></div>
            <p className={`${plusJakarta.className} text-sm md:text-[0.92rem] leading-snug md:leading-[1.63rem] font-semibold text-black text-center px-4 sm:px-6`}>
          ...
          <div className="w-full py-2 md:py-8 px-4 md:px-8 lg:px-12 flex flex-col md:flex-row items-center md:items-start justify-between">
            ...
            <div className="w-full md:w-5/12 text-center md:text-left mt-6 order-2 md:order-1">
              <h2 className={`${plusJakarta.className} font-medium text-2xl leading-[1.2] tracking-normal text-gray-800 mt-4 md:mt-9`}>
              ...
              <p className={`${plusJakarta.className} font-normal text-[12.63px] leading-[1.3] text-[#7E7E7E] mb-6 mt-6`}>
      ...
      <div className="why py-8 md:py-12 px-4 md:px-6">
        {/* Title Section */}
        <h1 className={`${plusJakarta.className} text-[28px] sm:text-[35px] md:text-[41px] lg:text-[45px] leading-[130%] tracking-[-0.02em] font-bold text-center text-gray-800 mb-4 sm:mb-5 md:mb-6`}>
          Why StudentAdda?
        </h1>
      ...
      <div className="what px-4 py-8 md:py-16 text-center">
        {/* Heading */}
        <h1 className={`${plusJakarta.className} text-[32px] sm:text-[36px] md:text-[41px] lg:text-[45px] leading-tight tracking-[-0.04em] font-bold text-center text-gray-800 mb-4 sm:mb-5 md:mb-6`}>
          What is Student Adda
        </h1>
        ...
        {/* Description */}
        <p className={`${plusJakarta.className} text-gray-600 text-[15px] leading-[23px] tracking-[-0.04em] font-normal sm:font-semibold max-w-xs sm:max-w-lg md:max-w-2xl mx-auto mb-10`}>
      ...
      <div className="px-4 sm:px-8 md:px-16 lg:px-24 xl:px-44 py-12 md:py-20 w-full">
        <div className="py-8 md:py-16 lg:py-30 px-4 md:px-20 mb-12 bg-[#EFEAE5] mt-6 md:mt-12 text-black rounded-xl">
          ...
          <div className="flex flex-col md:flex-row justify-between gap-6 mb-8 md:mb-16">
            ...
            <div className="md:w-[35%] text-center md:text-left">
              <h2 className={`${urbanist.className} text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 leading-snug mb-4`}>
                Explore Our <br />
                <span className="text-[#824800]">Standout Features</span>
              </h2>

              <div className="w-32 h-2 bg-[#824800] mb-6 rounded mx-auto md:mx-0"></div>
            </div>
            ...
            <div className="md:w-[70%] grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div className="bg-white p-4 md:p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform min-h-[180px] md:min-h-[200px]">
                ...
                <p className={`${plusJakarta.className} text-[10px] leading-[21.79px] tracking-normal font-normal text-gray-600 mb-4`}>
                  Stay focused with structured breaks to boost productivity while studying or working.
                </p>
                <div className="text-black font-medium flex gap-2 cursor-pointer text-xs md:text-sm mt-auto">
                  Learn More
              ...
              <div className="bg-white p-4 md:p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform min-h-[180px] md:min-h-[200px]">
                ...
                <h3 className={`${plusJakarta.className} text-[15.98px] leading-[21.79px] tracking-normal font-bold text-[#034833] mb-2`}>
                  Daily Planner
                </h3>
                <p className={`${plusJakarta.className} text-[10px] leading-[21.79px] tracking-normal font-normal text-gray-600 mb-4`}>
                ...
                <div className="text-black font-medium flex gap-2 mt-6 md:mt-12 cursor-pointer text-xs md:text-sm">
                  Learn More
                  <ArrowRight size={14} className="text-black mt-0.5" />
                </div>
              </div>
          ...
          {/* 3 Cards Row */}
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-8 justify-center">
            {/* Card 3 */}
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform w-full sm:w-[48%] md:w-[31%]">
              ...
              <div className="text-black font-medium flex gap-2 cursor-pointer text-xs md:text-sm">
                Learn More
                <ArrowRight size={14} className="text-black mt-0.5" />
              </div>
            </div>
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform w-full sm:w-[48%] md:w-[31%]">
              ...
              <div className="text-black flex font-medium gap-2 cursor-pointer text-xs md:text-sm">
                Learn More
                <ArrowRight size={14} className="text-black mt-0.5" />
              </div>
            </div>
        ...
        <div className="w-full px-4 sm:px-8 md:px-16 text-black bg-[#796146] mt-16 md:mt-[-90px] flex flex-col md:flex-row items-center justify-between rounded-3xl max-w-xs sm:max-w-lg md:max-w-xl lg:max-w-3xl xl:max-w-4xl mx-auto py-4 md:py-6">
          ...
          <div className="left max-w-xs sm:max-w-md md:max-w-lg text-center md:text-left flex flex-col items-center md:items-start">
            <h2 className={`${plusJakarta.className} text-[28px] leading-[34px] tracking-normal font-bold text-[#ffffff] mb-2`}>
              Are you ready to start?
            </h2>

            <p className={`${plusJakarta.className} text-[12px] leading-[18px] tracking-normal font-normal text-gray-200 mb-4 md:mb-6`}>
            ...
            <div className="input_part flex flex-col md:flex-row justify-center md:justify-start gap-4 w-full">
              <input
                ...
                className="px-4 py-2 w-full sm:w-[200px] md:w-[250px] lg:w-[300px] rounded-full border border-gray-300 text-xs md:text-sm bg-transparent text-white focus:outline-none focus:ring-2 focus:ring-white"
              />
        ...
        <div className="w-full mt-12 md:mt-24 px-4 py-8 sm:px-6">
          <div className="flex flex-col lg:flex-row gap-6 md:gap-10">
            ...
            <div className="lg:w-1/2 flex flex-col gap-4 md:gap-6 mt-6 lg:mt-0">
              ...
              {/* Main Title */}
              <h2 className={`${plusJakarta.className} text-[37.38px] leading-[44.86px] tracking-normal font-bold text-black mb-2`}>
                FAQ and Help Center
              </h2>
