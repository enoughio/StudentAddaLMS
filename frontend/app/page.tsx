...
export default function Home(){
  return (
    <div className="w-full min-h-screen bg-[#ECE3DA]">
      ...
      <div className="w-full px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col md:flex-row items-start">
        {/* Left Advertisement */}
        <div className="hidden md:block md:w-1/6 py-4 flex items-center justify-center" style={{ height: "100%" }}>
          ...
          <div className="w-full py-2 md:py-8 px-4 md:px-8 lg:px-12 flex flex-col md:flex-row items-center md:items-start justify-between">
            ...
            <h2 className="font-[Plus_Jakarta_Sans] font-medium text-2xl leading-[1.2] tracking-normal text-gray-800 mt-4 md:mt-9">
              ...
              <p className="font-[400] text-[12.63px] leading-[1.3]  font-['Plus_Jakarta_Sans'] text-[#7E7E7E] mb-6 mt-6">
                Student Adda brings together everything you <br /> need — book a seat at nearby libraries, stay <br /> productive with built-in tools, and engage in <br /> meaningful Q&A through our community <br />forums. Study smarter, not harder.
              </p>
              ...
              <div className="mt-6 md:mt-8 flex flex-wrap justify-center md:justify-start gap-3 md:gap-4 lg:gap-8 text-center md:text-left">
                  <div className="experience-item">
                    <h1 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900">13 Years</h1>
                    <p className="text-[10px] sm:text-xs lg:text-sm text-gray-600">Experience</p>
                  </div>
                  <div className="experience-item">
                    <h1 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900">256+</h1>
                    <p className="text-[10px] sm:text-xs lg:text-sm text-gray-600">Clients</p>
                  </div>
                  <div className="experience-item">
                    <h1 className="text-base sm:text-lg lg:text-xl font-semibold text-gray-900">99.8%</h1>
  ...
  Why StudentAdda?
        ...
        <div className="w-full px-2 sm:px-4 md:px-9 flex flex-col md:flex-row items-stretch">
          {/* Left Advertisement */}
          <div className="hidden md:block md:w-1/4 py-4 flex items-center justify-center" style={{ height: "100%" }}>
  ...
  <img src="/home/icon1.png" alt="Pomodoro Icon" className="w-5 h-5 object-contain" />
</div>
              ...
              <div className="bg-white p-4 md:p-6 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform min-h-[180px] md:min-h-[200px]">
                <div className="w-10 h-10 md:w-12 md:h-12 border-3 border-[#E3DBD8] rounded-full flex items-center justify-center mb-4 md:mb-6 mt-2 ">
                  <img src="/home/icon2.png" alt="Planner Icon" className="w-3 h-3 md:w-4 md:h-4" />
                </div>
                <h1 className="text-[15.98px] leading-[21.79px] tracking-normal font-bold text-[#034833] mb-2 font-['Plus_Jakarta_Sans']">Daily Planner</h1>
                <p className="text-[10px] leading-[21.79px] tracking-normal font-normal text-gray-600 mb-4  font-['Plus_Jakarta_Sans']">
          ...
          <div className="flex flex-col sm:flex-row flex-wrap gap-4 md:gap-8">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform w-full sm:w-[48%] md:w-[31%]">
              <div className="w-10 h-10 md:w-12 md:h-12 border-2 border-[#E3DBD8] rounded-full flex items-center justify-center mb-4 md:mb-6">
                <img src="/home/icon3.png" alt="Time Tracker Icon" className="w-4 h-4 md:w-5 md:h-5" />
              </div>
              <h1 className="text-[15.98px] leading-[21.79px] tracking-normal font-bold text-[#034833] mb-2 font-['Plus_Jakarta_Sans']">Time Tracker</h1>
              <p className="text-[10px] leading-[21.79px] tracking-normal font-normal text-gray-600 mb-4  font-['Plus_Jakarta_Sans']">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform w-full sm:w-[48%] md:w-[31%]">
              <div className="w-10 h-10 md:w-12 md:h-12 border-2 border-[#E3DBD8] rounded-full flex items-center justify-center mb-4 md:mb-6">
                <img src="/home/icon4.png" alt="Streak Icon" className="w-4 h-4 md:w-5 md:h-5" />
              </div>
              <h1 className="text-[15.98px] leading-[21.79px] tracking-normal font-bold text-[#034833] mb-2 font-['Plus_Jakarta_Sans']">Streak Overview</h1>
              <p className="text-[10px] leading-[21.79px] tracking-normal font-normal text-gray-600 mb-4  font-['Plus_Jakarta_Sans']">
            ...
            <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md hover:shadow-xl transition duration-300 border border-gray-100 hover:-translate-y-1 transform w-full sm:w-[48%] md:w-[31%]">
              <div className="w-10 h-10 md:w-12 md:h-12 border-2 border-[#E3DBD8] rounded-full flex items-center justify-center mb-4 md:mb-6">
                <img src="/home/icon5.png" alt="Focus Music Icon" className="w-4 h-4 md:w-5 md:h-5" />
              </div>
            ...
            Focus Music
              ...
              <h2 className="text-black flex font-medium gap-2 cursor-pointer  text-xs md:text-sm">
                Learn More <ArrowRight size={14} className="text-black mt-0.5"  />
              </h2>
            </div>
          </div>
        </div>
